...
<body>
        ...
        <div class="row g-0 d-none d-lg-flex">
            ...
            <div class="col-lg-6 text-end">
                <div class="h-100 topbar-right d-inline-flex align-items-center text-white py-2 px-5">
                    ...
                    <span class="fs-5 fw-bold">+971 56 151 8964</span> -->
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 text-start">
                                    <p class="fs-5 fw-medium text-primary text-uppercase animated slideInRight">5 Years
                ...
                <div class="carousel-item ">
                    <img class="w-100" src="img/slider-main/greyson-joralemon-A1g0oeX29ec-unsplash.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 text-start">
                            <h1 class="display-1 text-white mb-5 animated slideInRight">Human Resources and Modern Equipments.</h1>
                                    <a href="" class="btn btn-primary py-3 px-5 animated slideInRight">Explore More</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row gx-3 h-100">
                        <div class="col-6 align-self-start wow fadeInUp" data-wow-delay="0.1s">
                            <img class="img-fluid" src="img/lead/view-male-engineer-work-engineers-day-celebration_23-2151615052.jpg">
                        </div>
                        <div class="col-6 align-self-end wow fadeInDown" data-wow-delay="0.1s">
                            <img class="img-fluid" src="img/lead/painter.jpg">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">We lead the industrial market with cutting-edge solutions and unmatched efficiency, setting the standard for excellence.   </p>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-4">
                            <p><i class="fa fa-check text-primary me-2"></i>Plaster Works</p>
                            <p><i class="fa fa-check text-primary me-2"></i>Floor & Wall Tiling </p>
                            <p><i class="fa fa-check text-primary me-2"></i>Painting Contracting</p>
                            <p><i class="fa fa-check text-primary me-2"></i>Carpentery & Wood Flooring</p> 
                            <p><i class="fa fa-check text-primary me-2"></i>AC Installation & Maintenance</p>
                            <p><i class="fa fa-check text-primary me-2"></i>False Ceiling & Light Partitions </p>
    ...
    <div class="container-fluid facts my-5 p-5">
        <div class="row g-5">
            <p class="fw-medium text-uppercase text-primary text-center">Upto Now</p>
            ...
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay="0.5s">
                <div class="text-center border p-5">
                    ...
                    <h1 class="display-2 text-primary mb-0" data-toggle="counter-up">125</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">We deliver unparalleled quality, innovative solutions, and exceptional customer service on every project.
                    </p>
                    <div class="row gy-4">
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>Our team comprises highly skilled professionals with extensive industry experience.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>Our experienced professionals provide reliable solutions tailored to your needs.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>Our customer service is available 24/7 to assist with any issues or inquiries.</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="ratio ratio-16x9">
                        <video  src="./img/slider-main/GENERAL CONSTRUCTION - 60th ANNIVERSARY VIDEO (English).mp4" autoplay muted controls></video>

                        <!-- <iframe class="embed-responsive-item" src="./img/slider-main/GENERAL CONSTRUCTION - 60th ANNIVERSARY VIDEO (English).mp4" id="video" allowfullscreen
    ...
    <div class="container-xxl py-5">
        ...
        $query = "SELECT * FROM services ORDER BY service_type ASC";
        ...
        ?>
           ...
           <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="service-item">
                    ...
                    <?php if ($image != "") : ?>
                        <img class="img-fluid  mx-auto mb-5" src="admin/img/service/<?php echo $image; ?>" >
                    <?php else : ?>
                        <img class="img-fluid  mx-auto mb-5" src="admin/img/service/default.png" alt="Default Image">
                    <?php endif; ?>
                  
                    
                    <!-- <img class="img-fluid" src="img/services/elec4 (1).jpg" alt=""> -->
                    ...
                    <?php endif; ?>
                        ...
                        <div class="service-detail">
                            <div class="service-title">
                                <hr class="w-25">
                                <h3 class="mb-0"><?php echo $service_type; ?></h3>
                                <hr class="w-25">
                            </div>
                            <div class="service-text">
                                <p class="text-white mb-0"><?php echo $description; ?></p>
                            </div>
                        </div>
...
?>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text text-center  rounded p-4">
                    ...
                    <h6 class="mt-1">(<?php echo $profession; ?>)</h6>
                </div>
            </div>
        <?php
            }
