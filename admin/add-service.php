...
<h3 class="text-light"> <i class="fa fa-plus text-danger"></i> Add Service</h3>

<h3 class="d-flex justify-content-end"> <a href="service.php" class=" text-light"><i class="fa fa-eye text-danger"></i> View Services</a></h3>
...
<div class="col-lg-6 mt-3 input-group-lg">
        ...
        <input type="text" class="form-control" id="val-username" name="service_type" placeholder="Enter here..." required>
    ...
    <div class="row">
        <div class="col text-end">
            <button class="btn btn-light btn-lg mt-5 w-30">Add Service</button>
        </div>
    </div>
</div>
</form>
