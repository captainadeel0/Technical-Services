        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="project.php" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Projects</a>
...
<h3 class="text-light"> <i class="fa fa-plus text-danger"></i> Add Project</h3>

<h3 class="d-flex justify-content-end"> <a href="project.php" class=" text-light"><i class="fa fa-eye text-danger"></i> View Project</a></h3>


<hr>

<form action="./add-project-query.php" method="POST" enctype="multipart/form-data" class="row">
<div class="col-lg-6 mt-3 input-group-lg">
        <label class="form-label" for="val-username">Project Type <span class="text-danger">*</span>
        </label>
        <input type="text" class="form-control" id="val-username" name="project_type" placeholder="Enter here..." required>
    ...
    <div class="row">
        <div class="col text-end">
            <button class="btn btn-light btn-lg mt-5 w-30">Add Project</button>
        </div>
    </div>
</div>
</form>
