    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
          ...
          <div class="row m-0">
            ...
            <h3 class="text-light"> <i class="fa fa-eye text-danger"> &nbsp; </i>Projects</h3>
            <hr>

            <div class="d-flex justify-content-end">
                <h3><a href="#" class="text-light"><i class="fa fa-plus text-danger"></i> Add Project</a></h3>
            </div>
...
?>
                    ...
                    <tr>
                            ...
                            <td><img src="./img/project/<?php echo $row['image'] ?>" height="50px" alt=""></td>
                ...
                <h1 class="text-center text-danger mt-5" style>UNDER  </br> CONSTRUCTION</h1>
