...
<body>
        ...
        <div class="container">
            <div class="row g-5 justify-content-center mb-5">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">+971 56 151 8964</p>
                        <p class="mb-4">+971 56 151 8964</p>
                        <a class="btn btn-primary px-4" href="tel:+971561518964">Call Now <i
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">ilyasanjum6674@gmail.com</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <h4 class="mb-3">123 Street Dubai</h4>
                        <p class="mb-2">+971 56 151 8964</p>
                        <p class="mb-4">+971 56 151 8964</p>
            ...
            <div class="row g-5">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            <div class="d-flex">
                                ...
                                <div class="ms-3">
                                    <h6>Mail Us</h6>
                                    <span>ilyasanjum6674@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form action="./contact-query.php" method="POST">
                        <div class="row g-3">
                            <div class="col-md-6">
 ...
 <div class="container-fluid  footer mt-5 py-5 wow fadeIn" data-wow-delay="0.1s" style="background-color: rgba(24, 22, 22, 0.925)">
    ...
    if (isset($_SESSION['error'])) {
        echo '<div class="alert" id="alert">' . $_SESSION['error'] . '</div>';
